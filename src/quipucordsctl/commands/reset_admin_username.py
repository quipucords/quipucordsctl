...
def setup_parser(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        help=_(
            ...
            "(default: use environment variable or prompt if not set)"
        ),
    )
...
reset_username_messages = secrets.ResetSecretMessages(
    ...
    prompt_confirm_value=_("Confirm admin login username: "),
...
def run(args: argparse.Namespace) -> bool:
    ...
    If --prompt is used, skip environment variable and force interactive prompt.
    """
